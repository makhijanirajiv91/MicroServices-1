...
public class HelloController {
	...
	public MyPojo getPojo() {
		...
		MyPojo result = restTemplate.getForObject("http://serviceB/createPojo", MyPojo.class);
		System.out.println(result);
		return result;
	...
	public MyPojo createPojo(@RequestBody MyPojo pojo) {
		MyPojo result = restTemplate.postForObject("http://serviceB/actualCreatePojo",pojo,
				  MyPojo.class);
		System.out.println(result);
		return result;
